...
export async function generateMetadata({ params }: Props): Promise<Metadata> { const check = getValidationCheck((await params).validationId); return { title: check ? `${check.name} · Validation · Corvetra` : "Validation · Corvetra" }; }
