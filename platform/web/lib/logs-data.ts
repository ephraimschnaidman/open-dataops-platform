...
export const logEvents: LogEvent[] = [
    { id: "evt-001", timestamp: "2026-08-10T14:42:38.412Z", level: "Error", pipeline: "Customer Ingestion", pipelineId: "customer-ingestion", runId: "run_01J92CING8", runLabel: "8F42A1", stage: "Extract", environment: "Production", source: "Production Warehouse", sourceId: "billing-postgres", sourceType: "PostgreSQL", component: "extractor", platformCode: "PIPELINE_EXECUTION_FAILED", vendorCode: "SQLSTATE 08006", message: "Database connection interrupted during extraction.", interpretation: "The extraction stopped after the source connection closed unexpectedly.", details: { attempt: 3, max_attempts: 3, host: "prod-db.internal", database: "warehouse", elapsed_ms: 34102, component: "extractor", credential: "[REDACTED]" }, stackTrace: "ConnectionError: database connection reset by peer\n    at PostgreSQLExtractor.read (extractor.ts:184:17)\n    at async ExtractStage.execute (stage.ts:72:9)\nCaused by: SQLSTATE 08006 connection_failure", relatedAlert: { id: "ALT-1042", status: "Acknowledged" } },
    { id: "evt-002", timestamp: "2026-08-10T14:42:37.981Z", level: "Warning", pipeline: "Customer Ingestion", pipelineId: "customer-ingestion", runId: "run_01J92CING8", runLabel: "8F42A1", stage: "Extract", environment: "Production", source: "Production Warehouse", sourceId: "billing-postgres", sourceType: "PostgreSQL", component: "extractor", platformCode: "SOURCE_CONNECTION_RETRY_FAILED", message: "Connection retry 3/3 failed.", details: { attempt: 3, max_attempts: 3, backoff_ms: 4000, component: "extractor" } },
    { id: "evt-003", timestamp: "2026-08-10T14:42:36.125Z", level: "Warning", pipeline: "Customer Ingestion", pipelineId: "customer-ingestion", runId: "run_01J92CING8", runLabel: "8F42A1", stage: "Extract", environment: "Production", source: "Production Warehouse", sourceId: "billing-postgres", sourceType: "PostgreSQL", component: "extractor", platformCode: "SOURCE_CONNECTION_RETRY_FAILED", message: "Connection retry 2/3 failed.", details: { attempt: 2, max_attempts: 3, backoff_ms: 2000 } },
    { id: "evt-004", timestamp: "2026-08-10T14:42:35.204Z", level: "Info", pipeline: "Customer Ingestion", pipelineId: "customer-ingestion", runId: "run_01J92CING8", runLabel: "8F42A1", stage: "Extract", environment: "Production", source: "Production Warehouse", sourceId: "billing-postgres", sourceType: "PostgreSQL", component: "extractor", message: "Extracting customer_orders.", details: { table: "customer_orders", batch_size: 5000 } },
    ...
    { id: "evt-008", timestamp: "2026-08-10T14:35:04.008Z", level: "Warning", environment: "Production", source: "Production Warehouse", sourceId: "billing-postgres", sourceType: "PostgreSQL", component: "source-monitor", platformCode: "SOURCE_LATENCY_ELEVATED", message: "Source response latency exceeded the operational threshold.", details: { latency_ms: 418, threshold_ms: 300, region: "us-east-1" } },
